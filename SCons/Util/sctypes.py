...
# return value similar to isinstance(), albeit not as precise. 3.13 will bring
# TypeIs which may offer even more precision, but that's yet to be implemented.
if sys.version_info >= (3, 10):
    from typing import TypeGuard, TypeAlias

    DictTypeRet: TypeAlias = TypeGuard[Union[dict, UserDict]]  # type: ignore
    ListTypeRet: TypeAlias = TypeGuard[Union[list, UserList, deque]]  # type: ignore
    SequenceTypeRet: TypeAlias = TypeGuard[Union[list, tuple, deque, UserList, MappingView]]  # type: ignore
    TupleTypeRet: TypeAlias = TypeGuard[tuple]  # type: ignore
    StringTypeRet: TypeAlias = TypeGuard[Union[str, UserString]]  # type: ignore
else:
